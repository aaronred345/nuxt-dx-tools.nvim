...
describe('NuxtProjectManager', () => {
  let manager: NuxtProjectManager;
  const testRoot = '/test/nuxt-project';

  beforeEach(() => {
    manager = new NuxtProjectManager(testRoot);
  });
  ...
  describe('initialization', function() {
    ...
    it('should handle null or undefined root', () => {
      const managerWithNull = new NuxtProjectManager('');
  ...
  describe('getComponentMappings', () => {
    ...
    it('should not crash on invalid .nuxt directory', () => {
      const invalidManager = new NuxtProjectManager('/invalid/path/that/does/not/exist');
  ...
  describe('detectNuxtVersion', () => {
    it('should handle missing package.json', () => {
      const invalidManager = new NuxtProjectManager('/nonexistent/path');
      // Should not crash
